...
/* TSc controller */
#ifndef CONFIG_MACH_SYSTEMTERA_SERVERV
...
#endif /* CONFIG_MACH_SYSTEMTERA_SERVERV */

static struct adc_data am335x_adc_data = {
#ifdef CONFIG_MACH_SYSTEMTERA_SERVERV
	.adc_channels = 8,
#else
	.adc_channels = 4,
#endif /* CONFIG_MACH_SYSTEMTERA_SERVERV */
...
static struct omap2_hsmmc_info am335x_mmc[] __initdata = {
	{
		...
		.gpio_cd        = -EINVAL, //GPIO_TO_PIN(1, 28),
		.gpio_wp        = -EINVAL,
...
static struct pinmux_config knx_pin_mux[] = {
	{"uart1_rxd.uart1_rxd", OMAP_MUX_MODE0 | AM33XX_PIN_INPUT_PULLUP},
	{"uart1_txd.uart1_txd", OMAP_MUX_MODE0 | AM33XX_PULL_ENBL},
	{"mii1_rxclk.gpio3_10",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* NCN5120 nSave signal */
	{"mii1_txd3.gpio0_16",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},          /* KNX programming mode led */
	{"mii1_txd2.gpio0_17",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* KNX programming mode button */
	{NULL, 0},
};

/* SystemTera.Server.V specific pin mux for digital inputs */
static struct pinmux_config digital_in_pin_mux[] = {
	{"gpmc_a4.gpio1_20",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN1 */
	{"gpmc_a2.gpio1_18",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN2 */
	{"gpmc_a0.gpio1_16",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN3 */
	{"gpmc_a6.gpio1_22",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN4 */
	{"gpmc_a8.gpio1_24",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN5 */
	{"gpmc_a10.gpio1_26",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN6 */
	{"gpmc_a7.gpio1_23",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN7 */
	{"gpmc_a5.gpio1_21",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* IN8 */
	{NULL, 0},
};

/* SystemTera.Server.V specific pin mux for relais outputs */
static struct pinmux_config digital_out_pin_mux[] = {
	{"gpmc_a9.gpio1_25",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* OUT1 */
	{"gpmc_a11.gpio1_27",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* OUT2 */
	{NULL, 0},
};

/* SystemTera.Server.V specific pin mux for EIA-485 half-duplex uart */
/* uart3 initialized already in uart_init() */
static struct pinmux_config eia485_pin_mux[] = {
	{"emu1.gpio3_8",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* TX enable */
	{NULL, 0},
};

/* SystemTera.Server.V specific pin mux for general purpose red/green leds */
static struct pinmux_config gpled_pin_mux[] = {
	{"lcd_ac_bias_en.gpio2_25",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* LED 1 red */
	{"gpmc_a3.gpio1_19",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* LED 1 green */
	{"gpmc_a1.gpio1_17",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* LED 2 green */
	{"lcd_hsync.gpio2_23",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* LED 2 red */
	{"lcd_pclk.gpio2_24",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* LED 3 green */
	{"gpmc_csn3.gpio2_0",	OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},  /* LED 3 red */
	{NULL, 0},
};

/* SystemTera.Server.V specific pin mux for miscellaneous functions */
static struct pinmux_config misc_pin_mux[] = {
	{"emu0.gpio3_7",	OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLDOWN},  /* Optional Switch */
	{NULL, 0},
};
...
static void systemtera_serverv_init(void)
{
        ...
        setup_pin_mux(digital_in_pin_mux);
        setup_pin_mux(digital_out_pin_mux);
